...
part 'add_snack_event.dart';
part 'add_snack_state.dart';

class AddSnackBloc extends Bloc<AddSnackEvent, AddSnackState> {
  File _chosenImage;
  String _url;

  @override
  AddSnackState get initialState => AddSnackInitial();

  @override
  Stream<AddSnackState> mapEventToState(
    AddSnackEvent event,
  ) async* {
  ...
  Future<bool> _uploadFile() async {
    try {
      ...
      StorageReference reference = FirebaseStorage.instance
          .ref()
          .child("snacks/${Path.basename(filePath)}");
