...
part 'add_hotdogs_event.dart';
part 'add_hotdogs_state.dart';

class AddHotdogsBloc extends Bloc<AddHotdogsEvent, AddHotdogsState> {
  File _chosenImage;
  String _url;

  @override
  AddHotdogsState get initialState => AddHotdogsInitial();

  @override
  Stream<AddHotdogsState> mapEventToState(
    AddHotdogsEvent event,
  ) async* {
  ...
  Future<bool> _uploadFile() async {
    try {
      ...
      StorageReference reference = FirebaseStorage.instance
          .ref()
          .child("hotdogs/${Path.basename(filePath)}");
